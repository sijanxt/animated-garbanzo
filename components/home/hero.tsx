...
export default function Hero({ startTimeline, fadeOut }: HeroProps) {
  return (
    <section id="hero" className="relative overflow-hidden bg-black min-h-screen flex items-center justify-center">
      {/* Content */}
      <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
        <p className={`mb-6 text-xs uppercase tracking-[0.45em] text-zinc-400 transition-opacity duration-700 ${fadeOut ? "opacity-0" : "opacity-100 animate-fade-in"}`}>
